...
Para este ejercicio, las unidades de observación fueron productores agropecuarios y establecimientos conocidos o con ubicaciones accesibles para los entrevistadores; no siendo esta una muestra representativa, por lo que sus resultados no tienen representatividad estadística. La recolección de los datos en campo ha sido realizada por los participantes voluntarios y alumnos de instituciones académicas que forman parte de la RED 12.3 PDA México[^1^], o que estudian el fenómeno de la pérdida y desperdicio de alimentos desde alguna de sus dimensiones e implicaciones (económica, social, ambiental, cultural). 
...
En cuanto a los resultados, la única propuesta sobre cómo presentar lo conceptual y la estrategia operativa, fue implementar una difusión a través de contacto con clúster (agroalimentario, biotecnología y similares de acuerdo a los estados), videos y folletos para enviar en distintas plataformas digitales.
