...
De los 222 capacitados, cerca del 82% lograron realizar entrevistas, la mayoría de estas se llevaron a cabo entre familiares y conocidos, principalmente debido a que la situación de pandemia les impidió aplicar la muestra diseñada para cada entidad. Otros factores se deben a la negativa de participar, desconfianza de los informantes sobre el uso que se le pudiera dar a su información y, sobre todo, la falta de interés de algunos informantes, Esto desalentó a varios de los capacitados para cumplir con las metas establecidas en común acuerdo con sus supervisores.
...
Sobre el contenido de las preguntas del cuestionario, la mayoría de los supervisores externaron su opinión, para algunos les pareció bien, otro comentó que las tablas de causas y destino no se comprendieron a la primera, para alguien más las preguntas sobre pociones y piezas fueron las complicadas de comprender. Un supervisor hace la sugerencia de suplir el concepto de porcentaje por dos preguntas que permitan obtener el cálculo automático de este mismo. 
...
Los aspectos que proponen cambiar/ajustar en el marco conceptual son, ellos mencionan:
...
En cuanto a los resultados, la única propuesta sobre cómo presentar en cuanto a lo conceptual y la estrategia operativa, fue la implementar una difusión a través de contacto con cluster (agroalimentario, biotecnología y similares de acuerdo a los estados), videos y folletos para enviar en distintas plataformas digitales.
