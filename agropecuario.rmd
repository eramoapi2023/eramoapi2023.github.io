---
title: '**Resultados Agropecuario Prueba Piloto 2021**'
output:
  html_document:
    df_print: paged
...
# **1. Resultados de las Unidades de Producción Agrícola y Unidades de Producción Pecuaria**

<br>

## 1.1. Unidades de producción que llevan registro en el manejo o pérdida de los productos
...
colors <- c('rgb(214, 234, 248)', 'rgb(33, 97, 140)')
...
fig <- plot_ly(data, x = ~tipo, y = ~con_registro, type = 'bar', name = 'Con registro',
               marker = list(color = 'rgb(33, 97, 140))'))
fig <- fig %>% add_trace(y = ~sin_registro, name = 'Sin registro',
                         marker = list(color = 'rgb(214, 234, 248)', showlegend = TRUE))
...
## 1.2. Procesos en los que las Unidades de Producción llevan registro para el manejo o pérdida de sus productos.
...
## 1.3. Número de alimentos reportados por tipo de Unidad de Producción
...
## 1.5. Hectáreas cultivadas/sembradas de los productos reportados por las Unidades de Producción Agrícola.
...
fig <- plot_ly(data, x = ~producto, y = ~ha_prod, type = 'bar', 
      marker = list(color = 'rgb(214, 234, 250)'))
...
## 1.6. Destino de consumo de los productos reportados por Unidades de Producción.
...
#### 1.6.a. Destino de los productos declarados en las Unidades de Producción Agrícola
...
colors <- c('rgb(174, 214, 241)', 'rgb(214, 234, 248)', 'rgb(46, 134, 193)', 'rgb(33, 97, 140)')
...
#### 1.6.b. Destino de los productos declarados en las Unidades de Producción Pecuaria
...
colors <- c('rgb(33, 97, 140)', 'rgb(46, 134, 193)', 'rgb(214, 234, 248)', 'rgb(174, 214, 241)')
...
## 1.7. Mercado objetivo de los productos reportados por las Unidad de Producción.
...
#### 1.7.a. Mercado objetivo de los productos reportados en las Unidades de Producción Agrícola
...
colors <- c('rgb(46, 134, 193)', 'rgb(214, 234, 248)', 'rgb(174, 214, 241)', 'rgb(33, 97, 140)')
...
#### 1.7.b. Mercado objetivo de los productos reportados por Unidades de Producción Pecuaria
...
colors <- c('rgb(214, 234, 248)', 'rgb(174, 214, 241)', 'rgb(46, 134, 193)', 'rgb(33, 97, 140)')
...
## 1.8. Cosecha esperada vs. Cosecha final obtenida en las Unidades de Producción Agrícola.
...
## 1.9. Producción esperada vs. Producción obtenida en Unidades de Producción Pecuaria
...
# **2. Unidades de Producción Agrícola. Pérdidas, causas y destino**
...
### 2.1.1 Porcentaje de productos con al menos un registro de pérdida en alguno de sus proceso de producción
...
### 2.1.2. Porcentaje global de pérdida con respecto a las toneladas cosechadas.

#### 2.1.2.a. Porcentaje global de pérdida
...
colors <- c('rgb(174, 214, 241)', 'rgb(33, 97, 140)')
...
#### 2.1.2.b. Porcentaje de pérdida de alimentos (toneladas) en UP Agrícola por proceso
...
colors <- c('rgb(214, 234, 248)', 'rgb(46, 134, 193)', 'rgb(174, 214, 241)', 'rgb(33, 97, 140)', 'rgb(129, 164, 193 )', 'rgb(163, 195, 223)')
...
#### 2.1.2.c. Volumen de pérdida por proceso de producción
...
### 2.1.3. Porcentaje de pérdida por producto alimenticio reportado.

El Ajo y el Dátil reportaron valores porcentuales superiores al 90%, esto se debe a que son productos con poca representatividad y los pocos registros presentan un alto porcentaje de pérdida (ver gráfico).
...
## 2.2. Principales causas de la pérdida en los productos agrícolas declarados
...
## 2.3. Principales destinos de la pérdida en los productos agrícolas reportados
...
# **3. Unidades de Producción Pecuaria. Pérdidas, causas y destinos**
...
## 3.1. Pérdidas reportadas

### 3.1.1. Porcentaje de productos con al menos un registro de pérdida en alguno de sus proceso de producción.
...
colors <- c('rgb(214, 234, 248)', 'rgb(46, 134, 193)', 'rgb(174, 214, 241)', 'rgb(33, 97, 140)', 'rgb(220, 200, 200)', 'rgb(155, 200, 200)')
...
### 3.1.2. Porcentaje global de pérdida con respecto a las toneladas producidas.

<br>

#### 3.1.2.a. Porcentaje global de pérdida de alimentos en UP Pecuaria
...
#### 3.1.2.b. Porcentaje de pérdida por proceso de producción
...
data <- datos[,c('proceso', 'ton_perdida')]
colors <- c('rgb(214, 234, 248)', 'rgb(46, 134, 193)', 'rgb(174, 214, 241)', 'rgb(38, 121, 192)', 'rgb(195, 214, 239)', 'rgb(33, 97, 140)', 'rgb(174, 214, 241)')
fig <- plot_ly(data, labels = ~proceso, values = ~ton_perdida, type = 'pie',
textposition = 'outside',
textinfo = 'percent',
insidetextfont = list(color = '#FFFFFF'),
...
#### 3.1.2.c. Volumen de pérdida por proceso de producción
...
### 3.1.3. Porcentaje de pérdida por producto alimenticio. 

En las siguientes gráficas se aprecia el porcentaje de pérdida para cada uno de los productos reportados (3.1.3.a.), así como los datos atomizados (3.1.3.b.). 
<br>
...
## 3.2. Principales causas de la pérdida en los productos pecuario reportados
...
## 3.3. Principales destinos de la pérdida en los productos pecuario reportados
...
# **4. Bancos de alimentos, redes alimentarias y percepción ambiental**
...
## 4.1. Conocimiento sobre bancos de alimentos en las unidades de producción
...
colors <- c('rgb(174, 214, 241)', 'rgb(46, 134, 193)', 'rgb(33, 97, 140)', 'rgb(214, 234, 248)', 'rgb(155, 200, 200)', 'rgb(220, 200, 200)')
...
## 4.2. Conocimiento sobre Redes alimentarias en las unidades de producción
...
data <- datos[,c('resp', 'frec')]
colors <- c('rgb(214, 234, 248)', 'rgb(33, 97, 140)', 'rgb(174, 214, 241)', 'rgb(174, 214, 241)', 'rgb(46, 134, 193)', 'rgb(155, 200, 200)')
fig <- plot_ly(data, labels = ~resp, values = ~frec, type = 'pie',
textposition = 'outside',
textinfo = 'percent',
insidetextfont = list(color = '#FFFFFF'),
...
## 4.3. Otras alternativas de manejo

<br>

### 4.3.1. Porcentaje de productores que llevan a cabo acciones alternativas para el manejo de sus productos
...
#### 4.3.1.a. Alternativas para el manejo de los productos agrícolas
...
#### 4.3.1.b. Alternativas para el manejo de los productos pecuario
...
## 4.4. Conocimiento sobre Campañas para reducir la pérdida de alimentos
...
data <- datos[,c('resp', 'frec')]
colors <- c('rgb(214, 234, 248)', 'rgb(33, 97, 140)', 'rgb(174, 214, 241)', 'rgb(46, 134, 193)', 'rgb(155, 200, 200)')
fig <- plot_ly(data, labels = ~resp, values = ~frec, type = 'pie',
textposition = 'inside',
textinfo = 'percent',
insidetextfont = list(color = '#FFFFFF'),
...
## 4.5. Medidas para evitar o disminuir la pérdida de alimentos

<br>

### 4.5.1. Porcentaje de unidades de producción que ha tomado medidas para evitar o disminuir la pérdida de alimentos 
...
#### 4.5.1.a. Medidas adoptadas para evitar o disminuir la pérdida de productos en el sector Agrícola
...
#### 4.5.1.b. Medidas adoptadas para evitar o disminuir la pérdida de productos en el sector Pecuario
...
data <- datos[,c('resp', 'frec')]
colors <- c('rgb(214, 234, 248)', 'rgb(33, 97, 140)', 'rgb(174, 214, 241)', 'rgb(46, 134, 193)', 'rgb(195, 214, 239)')
fig <- plot_ly(data, labels = ~resp, values = ~frec, type = 'pie',
textposition = 'outside',
textinfo = 'percent',
insidetextfont = list(color = '#FFFFFF'),
